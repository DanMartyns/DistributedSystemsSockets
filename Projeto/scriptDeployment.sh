...
sshpass -e ssh -t -t -o StrictHostKeyChecking=no sd0401@l040101-ws01.ua.pt << EOF
	...
	nohup java -cp /home/sd0401/GeneralInformationRepo/src/ MainPackage.MainProgram > ../../../print.txt &
	exit
EOF
...
sshpass -e ssh -t -t -o StrictHostKeyChecking=no sd0401@l040101-ws02.ua.pt << EOF
	...
	nohup java -cp /home/sd0401/Lounge/src/ MainPackage.MainProgram > ../../../print.txt &
	exit
EOF
...
sshpass -e ssh -t -t -o StrictHostKeyChecking=no sd0401@l040101-ws03.ua.pt << EOF
	...
	nohup java -cp /home/sd0401/OutsideWorld/src/ MainPackage.MainProgram > ../../../print.txt & 
	exit
EOF
...
sshpass -e ssh -t -t -o StrictHostKeyChecking=no sd0401@l040101-ws04.ua.pt << EOF
	...
	nohup java -cp /home/sd0401/RepairArea/src/ MainPackage.MainProgram > ../../../print.txt &
	exit
EOF
...
sshpass -e ssh -t -t -o StrictHostKeyChecking=no sd0401@l040101-ws05.ua.pt << EOF
	...
	nohup java -cp /home/sd0401/Park/src/ MainPackage.MainProgram > ../../../print.txt &
	exit
EOF
...
sshpass -e ssh -t -t -o StrictHostKeyChecking=no sd0401@l040101-ws06.ua.pt << EOF
	...
	nohup java -cp /home/sd0401/SupplierSite/src/ MainPackage.MainProgram > ../../../print.txt &
	exit 
EOF
